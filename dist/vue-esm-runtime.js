...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.vueEsmRuntime = factory());
  ...
  class ScriptContext {
    ...
    _getNativeCompilerUrl() {
      ...
      return new URL('../vue-esm-runtime-native.js', (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('vue-esm-runtime.js', document.baseURI).href))).href;
    }
  }
